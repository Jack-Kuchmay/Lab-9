...
setwd("C:/Users/jacks/OneDrive/Documents/AGR 333 Labs")
#----------------
u2_data <- read.csv(U2_2017data)
#----------------
...
str(U2_2017data)
skimr::skim(U2_2017data)
dplyr::glimpse(U2_2017data)
#----------------
...
#----------------
u2_data <- U2_2017data %>% filter(!is.na(DBH), !is.na(Code))
#----------------
...
#----------------     
#SppCode <- read.csv()-----Can't read CSV from github related things. directly imported data from library
#---------------- 
...
#----------------
trees_merge <- merge(x = u2_data, y = Species_Codes, by.x = "Code", by.y = "SppCode", all.x = TRUE) 
#----------------
...
write.csv(x = trees, file = "Trees Data")
